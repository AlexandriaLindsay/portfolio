...
import Resume from '../../assets/images/alex-lindsay-resume.pdf';
            ...
            <LayoutDefault>
                <Section className="width-1500 hero">
                    <div className="hero-content">
                        <p className="code typing">Hello! My name is</p>
                        <div className="text-contain">
                            ...
                            <a className="animate__animated animate__fadeInUp animate__delay-3s custom-btn" href={Resume} target="_blank">Check Out My Resume!</a>
                        </div>
                    </div>
                ...
                <h2 className="mobile">01. ABOUT<span className="circle"></span><span className="circle"></span><span className="circle"></span><span className="circle"></span><span className="circle"></span><span className="circle"></span><span className="circle"></span><span className="circle"></span></h2>
                    ...
                    <div className="row">
                        <div className="column">
                            ...
                            <p>A few years later I began to dabble in game development, app development, etc. Only to discover that my true passion lies in web. Fast forward to today, and I've had the privilege to work at a <a href="https://psone.ca" target="_blank" rel="noopener noreferrer">marketing agency</a> where I'm currently a Full-Stack Developer and a mentor. My main focus most days is building high-end web experiences, learning new technologies, devlopment efficiency &amp; productivity, and our overall web process.</p>
                            <p>I also have a strong desire to learn new technologies that can improve my work. Here are a few I've been working with recently.</p>
                            <ul>
                                <li>React</li>
                    ...
                    <div className="row">
                        <div className="column">
                            <a className="project" href="https://echo.staging.prufs.ca/" target="_blank" rel="noreferrer noopener">
                                ...
                                <h3>Spartan Gym</h3>
                                <p>This is a side project I designed and developed using React as the front-end and WordPress as a headless CMS. Paried with the Apollo Client and GraphQL API to query data.</p>
                        ...
                        <div className="column">
                            <a className="project" href="https://prairiesurfaces.ca/court-designer/" target="_blank" rel="noreferrer noopener">
                                ...
                                <p>Developed website and a court builder interface that allows the user to create a custom court and submit their creation through a form. Used PHP to pass relavant data between pages.</p>
                                <button className="custom-btn">View</button>
                            </a>
                        </div>
                        <div className="column">
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            <a className="project" href="https://steinbachrealty.com/listings/" target="_blank" rel="noreferrer noopener">
                                ...
                                <p>With the aid of RealtyPress I created cron jobs to instruct the server to pull MLS listings every hour from the MLS feed.</p>
                                <button className="custom-btn">View</button>
                            </a>
                        </div>
                        <div className="column">
